            ...
            <div class="mt-4">
                <div class="flex items-center gap-2.5">
                    @if($item->status == 'Pending')
                        {{-- KUNING --}}
                        <span class="material-symbols-rounded text-yellow-600 text-[20px]">hourglass</span>
                        <span class="text-[14px] font-bold text-yellow-600">Pending</span>

                    @elseif($item->status == 'Approved')
                        {{-- HIJAU --}}
                        <span class="material-symbols-rounded text-green-600 text-[20px]">check</span>
                        <span class="text-[14px] font-bold text-green-600">Approved</span>

                    @elseif($item->status == 'Rejected')
                        {{-- MERAH --}}
                        <span class="material-symbols-rounded text-red-600 text-[20px]">cancel</span>
                    ...
                    @elseif($item->status == 'Completed')
                        {{-- BIRU --}}
                        <span class="material-symbols-rounded text-blue-600 text-[20px]">task_alt</span>
